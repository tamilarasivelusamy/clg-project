        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1"><ul class="nav  nav-pills nav-stacked">
                        ...
                        <li>
                            <a href="dic1.php"><i class="icon-group icon-large"></i>&nbsp;Project Proposal
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
			<ul>
			<li>
                            <a href="hdic1.php"><i class="icon-group icon-small"></i>&nbsp;BioTech Medicine
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-small"></i>
                                </div>  
                            </a></li>
			<li>
                            <a href="sdic1.php"><i class="icon-group icon-small"></i>&nbsp;BioTech Agriculture
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-small"></i>
                                </div>  
                            </a></li>
			<li>
                            <a href="defdic1.php"><i class="icon-group icon-small"></i>&nbsp;BioTech Food Processing
                                 
                            </a></li>
			<li>
                            <a href="adic1.php"><i class="icon-group icon-small"></i>&nbsp;Biotechnology in Animal
                                 
                            </a></li>
			<li>
                            <a href="dfddic1.php"><i class="icon-group icon-small"></i>&nbsp;Molecular Biotechnology
                                 
                            </a></li>
			<li class="active">
                            <a href="erddic1.php"><i class="icon-group icon-small"></i>&nbsp;Environmental Biotechnology
            ...
            <div class="span9">
				...
				<th>Category</th>
  				...
  				<th>Photo</th>
                        ...
                        <tbody>
                            <?php
                            $query = mysql_query("select * from dic where cat='Environmental Biotechnology'") or die(mysql_error());
