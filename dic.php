...
<div class="controls">
    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                       ...
                       <li class="active"><a href="dic.php"><i class="icon-file-alt icon-large"></i>&nbsp;Project Proposals
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                <a href="teacher_add_dic.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Project Proposal</a>
                <br></br>
                <div class="hero-unit-3">
				...
				<td><?php echo $row['cat']; ?></td> 
				  ...
				  <td width="50"><img class="img" src="<?php echo $row['photo']; ?>" height="100" width="100"></td>
